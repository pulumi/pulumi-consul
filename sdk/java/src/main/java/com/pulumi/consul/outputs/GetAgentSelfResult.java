...
public final class GetAgentSelfResult {
    ...
    public static final class Builder {
        ...
        public GetAgentSelfResult build() {
            final var o = new GetAgentSelfResult();
            o.aclDatacenter = aclDatacenter;
            o.aclDefaultPolicy = aclDefaultPolicy;
            o.aclDisabledTtl = aclDisabledTtl;
            o.aclDownPolicy = aclDownPolicy;
            o.aclEnforce08Semantics = aclEnforce08Semantics;
            o.aclTtl = aclTtl;
            o.addresses = addresses;
            o.advertiseAddr = advertiseAddr;
            o.advertiseAddrWan = advertiseAddrWan;
            o.advertiseAddrs = advertiseAddrs;
            o.atlasJoin = atlasJoin;
            o.bindAddr = bindAddr;
            o.bootstrapExpect = bootstrapExpect;
            o.bootstrapMode = bootstrapMode;
            o.checkDeregisterIntervalMin = checkDeregisterIntervalMin;
            o.checkReapInterval = checkReapInterval;
            o.checkUpdateInterval = checkUpdateInterval;
            o.clientAddr = clientAddr;
            o.dataDir = dataDir;
            o.datacenter = datacenter;
            o.devMode = devMode;
            o.dns = dns;
            o.dnsRecursors = dnsRecursors;
            o.domain = domain;
            o.enableAnonymousSignature = enableAnonymousSignature;
            o.enableCoordinates = enableCoordinates;
            o.enableDebug = enableDebug;
            o.enableRemoteExec = enableRemoteExec;
            o.enableSyslog = enableSyslog;
            o.enableUi = enableUi;
            o.enableUpdateCheck = enableUpdateCheck;
            o.id = id;
            o.leaveOnInt = leaveOnInt;
            o.leaveOnTerm = leaveOnTerm;
            o.logLevel = logLevel;
            o.name = name;
            ...
            o.reconnectTimeoutLan = reconnectTimeoutLan;
            o.reconnectTimeoutWan = reconnectTimeoutWan;
            o.rejoinAfterLeave = rejoinAfterLeave;
            o.retryJoinEc2 = retryJoinEc2;
            o.retryJoinGce = retryJoinGce;
            o.retryJoinWans = retryJoinWans;
            o.retryJoins = retryJoins;
            o.retryMaxAttempts = retryMaxAttempts;
            o.retryMaxAttemptsWan = retryMaxAttemptsWan;
            o.serfLanBindAddr = serfLanBindAddr;
            o.serfWanBindAddr = serfWanBindAddr;
            o.serverMode = serverMode;
            o.serverName = serverName;
            o.sessionTtlMin = sessionTtlMin;
            o.startJoinWans = startJoinWans;
            o.startJoins = startJoins;
            o.syslogFacility = syslogFacility;
            ...
            o.tlsVerifyIncoming = tlsVerifyIncoming;
            o.tlsVerifyOutgoing = tlsVerifyOutgoing;
            o.tlsVerifyServerHostname = tlsVerifyServerHostname;
            o.translateWanAddrs = translateWanAddrs;
            o.uiDir = uiDir;
            o.unixSockets = unixSockets;
            o.version = version;
            o.versionPrerelease = versionPrerelease;
            o.versionRevision = versionRevision;
            return o;
        }
    }
}
