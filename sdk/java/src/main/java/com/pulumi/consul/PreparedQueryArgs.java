...
public final class PreparedQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final PreparedQueryArgs Empty = new PreparedQueryArgs();
...
Please use the token argument in the provider configuration */
    ...
    private PreparedQueryArgs() {}

    private PreparedQueryArgs(PreparedQueryArgs $) {
    ...
    public static Builder builder(PreparedQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreparedQueryArgs();
        }

        public Builder(PreparedQueryArgs defaults) {
            $ = new PreparedQueryArgs(Objects.requireNonNull(defaults));
        }
