...
public final class KeyPrefixArgs extends com.pulumi.resources.ResourceArgs {

    public static final KeyPrefixArgs Empty = new KeyPrefixArgs();
...
Please use the token argument in the provider configuration */
    ...
    private KeyPrefixArgs() {}

    private KeyPrefixArgs(KeyPrefixArgs $) {
    ...
    public static Builder builder(KeyPrefixArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KeyPrefixArgs defaults) {
            $ = new KeyPrefixArgs(Objects.requireNonNull(defaults));
        }
...
Please use the token argument in the provider configuration */
        ...
        public KeyPrefixArgs build() {
            if ($.pathPrefix == null) {
                throw new MissingRequiredPropertyException("KeyPrefixArgs", "pathPrefix");
            }
            return $;
        }
    }
