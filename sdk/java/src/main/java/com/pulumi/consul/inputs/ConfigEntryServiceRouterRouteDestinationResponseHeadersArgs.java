...
public final class ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs() {}

    private ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs(ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs $) {
        this.add = $.add;
    ...
    public static Builder builder(ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs();
        }

        public Builder(ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs defaults) {
            $ = new ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs build() {
            return $;
        }
    }
