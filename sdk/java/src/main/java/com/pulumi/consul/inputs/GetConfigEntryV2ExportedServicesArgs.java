...
public final class GetConfigEntryV2ExportedServicesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetConfigEntryV2ExportedServicesArgs Empty = new GetConfigEntryV2ExportedServicesArgs();
    ...
    private GetConfigEntryV2ExportedServicesArgs() {}

    private GetConfigEntryV2ExportedServicesArgs(GetConfigEntryV2ExportedServicesArgs $) {
        this.kind = $.kind;
        this.name = $.name;
    ...
    public static Builder builder(GetConfigEntryV2ExportedServicesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConfigEntryV2ExportedServicesArgs();
        }

        public Builder(GetConfigEntryV2ExportedServicesArgs defaults) {
            $ = new GetConfigEntryV2ExportedServicesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConfigEntryV2ExportedServicesArgs build() {
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("GetConfigEntryV2ExportedServicesArgs", "kind");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetConfigEntryV2ExportedServicesArgs", "name");
            }
            return $;
        }
    }
