...
public final class IntentionState extends com.pulumi.resources.ResourceArgs {

    public static final IntentionState Empty = new IntentionState();
    ...
    public static Builder builder(IntentionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IntentionState defaults) {
            $ = new IntentionState(Objects.requireNonNull(defaults));
        }
