...
public final class ConfigEntryServiceRouterRouteDestinationResponseHeaders {
    ...
    public static Builder builder(ConfigEntryServiceRouterRouteDestinationResponseHeaders defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> set;
        public Builder() {}
        public Builder(ConfigEntryServiceRouterRouteDestinationResponseHeaders defaults) {
        ...
        public ConfigEntryServiceRouterRouteDestinationResponseHeaders build() {
            final var _resultValue = new ConfigEntryServiceRouterRouteDestinationResponseHeaders();
