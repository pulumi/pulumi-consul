...
public class AclPolicy extends com.pulumi.resources.CustomResource {
    ...
    public AclPolicy(String name, AclPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("consul:index/aclPolicy:AclPolicy", name, args == null ? AclPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AclPolicy(String name, Output<String> id, @Nullable AclPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("consul:index/aclPolicy:AclPolicy", name, state, makeResourceOptions(options, id));
    }
