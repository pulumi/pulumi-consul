...
public class PeeringToken extends com.pulumi.resources.CustomResource {
     ...
     */
    public PeeringToken(java.lang.String name) {
     ...
     */
    public PeeringToken(java.lang.String name, PeeringTokenArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PeeringToken(java.lang.String name, PeeringTokenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("consul:index/peeringToken:PeeringToken", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PeeringToken(java.lang.String name, Output<java.lang.String> id, @Nullable PeeringTokenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("consul:index/peeringToken:PeeringToken", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PeeringToken get(java.lang.String name, Output<java.lang.String> id, @Nullable PeeringTokenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
