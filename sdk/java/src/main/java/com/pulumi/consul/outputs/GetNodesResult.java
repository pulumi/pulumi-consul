...
public final class GetNodesResult {
    ...
    public static final class Builder {
        ...
        public Builder datacenter(String datacenter) {
            if (datacenter == null) {
              throw new MissingRequiredPropertyException("GetNodesResult", "datacenter");
            }
        ...
        public Builder nodeIds(List<String> nodeIds) {
            if (nodeIds == null) {
              throw new MissingRequiredPropertyException("GetNodesResult", "nodeIds");
            }
        ...
        public Builder nodeNames(List<String> nodeNames) {
            if (nodeNames == null) {
              throw new MissingRequiredPropertyException("GetNodesResult", "nodeNames");
            }
