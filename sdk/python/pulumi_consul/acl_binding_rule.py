...
class AclBindingRuleArgs:
    def __init__(__self__, *,
                 ...
                 bind_vars: pulumi.Input[Optional['AclBindingRuleBindVarsArgs']] = None,
    ...
    def bind_vars(self) -> pulumi.Input[Optional['AclBindingRuleBindVarsArgs']]:
        """
    ...
    @bind_vars.setter
    def bind_vars(self, value: pulumi.Input[Optional['AclBindingRuleBindVarsArgs']]):
...
class AclBindingRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bind_name: pulumi.Input[Optional[_builtins.str]] = None,
                 bind_type: pulumi.Input[Optional[_builtins.str]] = None,
                 bind_vars: pulumi.Input[Optional[Union['AclBindingRuleBindVarsArgs', 'AclBindingRuleBindVarsArgsDict']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 partition: pulumi.Input[Optional[_builtins.str]] = None,
                 selector: pulumi.Input[Optional[_builtins.str]] = None,
