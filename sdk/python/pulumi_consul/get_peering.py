...
def get_peering(partition: Optional[str] = None,
    ...
    return AwaitableGetPeeringResult(
        deleted_at=__ret__.deleted_at,
        id=__ret__.id,
        meta=__ret__.meta,
        partition=__ret__.partition,
        peer_ca_pems=__ret__.peer_ca_pems,
        peer_id=__ret__.peer_id,
        peer_name=__ret__.peer_name,
        peer_server_addresses=__ret__.peer_server_addresses,
        peer_server_name=__ret__.peer_server_name,
        state=__ret__.state)
