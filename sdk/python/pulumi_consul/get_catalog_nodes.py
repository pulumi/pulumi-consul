...
def get_catalog_nodes_output(query_options: pulumi.Input[Optional[Optional[Sequence[Union['GetCatalogNodesQueryOptionArgs', 'GetCatalogNodesQueryOptionArgsDict']]]]] = None,
