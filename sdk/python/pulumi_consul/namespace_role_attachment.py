...
class NamespaceRoleAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        you should use the `role_defaults` attribute of [`Namespace`](https://www.terraform.io/docs/providers/consul/r/namespace.html).
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            namespace: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'NamespaceRoleAttachment':
        """
