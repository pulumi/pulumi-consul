...
class PeeringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] peer_name: The name assigned to the peer cluster. The `peer_name` is used to reference the peer cluster in service discovery
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] meta: Specifies KV metadata to associate with the peering. This parameter is not required and does not directly impact the
...
class Peering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        eu = pulumi.providers.Consul("eu", address="eu-cluster:8500")
        us = pulumi.providers.Consul("us", address="us-cluster:8500")
