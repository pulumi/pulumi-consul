...
class AclAuthMethodNamespaceRuleArgs:
    ...
    def bind_namespace(self) -> pulumi.Input[_builtins.str]:
        """
        If the namespace rule's `selector` matches then this is used to control the namespace where the token is created.
        """
    ...
    def bind_namespace(self, value: pulumi.Input[_builtins.str]):
...
class AclRoleNodeIdentityArgs:
    def __init__(__self__, *,
                 ...
                 node_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] datacenter: Specifies the node's datacenter.
...
class AclTokenNodeIdentityArgs:
    def __init__(__self__, *,
                 ...
                 node_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] datacenter: The datacenter of the node.
        :param pulumi.Input[_builtins.str] node_name: The name of the node.
        """
        pulumi.set(__self__, "datacenter", datacenter)
        pulumi.set(__self__, "node_name", node_name)
...
class CatalogEntryServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] address: The address of the service. Defaults to the
               node address.
        :param pulumi.Input[_builtins.str] id: The ID of the service. Defaults to the `name`.
...
class ConfigEntryServiceDefaultsTransparentProxyArgsDict(TypedDict):
    dialed_directly: pulumi.Input[_builtins.bool]
    outbound_listener_port: pulumi.Input[_builtins.int]
...
class ConfigEntryServiceDefaultsTransparentProxyArgs:
    ...
    def dialed_directly(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "dialed_directly")

    @dialed_directly.setter
    def dialed_directly(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "dialed_directly", value)

    @_builtins.property
    @pulumi.getter(name="outboundListenerPort")
    def outbound_listener_port(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "outbound_listener_port")

    @outbound_listener_port.setter
    def outbound_listener_port(self, value: pulumi.Input[_builtins.int]):
...
class ConfigEntryServiceDefaultsUpstreamConfigDefaultLimitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_pending_requests: Specifies the maximum number of requests that are queued while waiting for a connection to establish.
        """
...
class ConfigEntryServiceDefaultsUpstreamConfigDefaultPassiveHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] interval: Specifies the time between checks.
        :param pulumi.Input[_builtins.int] max_ejection_percent: Specifies the maximum percentage of an upstream cluster that Consul ejects when the proxy reports an outlier.
        :param pulumi.Input[_builtins.int] max_failures: Specifies the number of consecutive failures allowed per check interval. If exceeded, Consul removes the host from the load balancer.
        """
...
class ConfigEntryServiceDefaultsUpstreamConfigOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace containing the upstream service that the configuration applies to.
        :param pulumi.Input[_builtins.str] partition: Specifies the name of the name of the Consul admin partition that the configuration entry applies to.
        ...
        :param pulumi.Input[_builtins.str] peer: Specifies the peer name of the upstream service that the configuration applies to.
        :param pulumi.Input[_builtins.str] protocol: Specifies the default protocol for the service.
        """
        if balance_outbound_connections is not None:
            pulumi.set(__self__, "balance_outbound_connections", balance_outbound_connections)
...
class ConfigEntryServiceIntentionsSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the source that the intention allows or denies traffic from.
        :param pulumi.Input[_builtins.str] namespace: Specifies the traffic source namespace that the intention allows or denies traffic from.
        :param pulumi.Input[_builtins.str] partition: Specifies the name of an admin partition that the intention allows or denies traffic from.
        :param pulumi.Input[_builtins.str] peer: Specifies the name of a peered Consul cluster that the intention allows or denies traffic from
        ...
        :param pulumi.Input[_builtins.int] precedence: The Precedence field contains a read-only integer. Consul generates the value based on name configurations for the source and destination services.
        :param pulumi.Input[_builtins.str] sameness_group: Specifies the name of a sameness group that the intention allows or denies traffic from.
        :param pulumi.Input[_builtins.str] type: Specifies the type of destination service that the configuration entry applies to.
        """
...
class ConfigEntryServiceIntentionsSourcePermissionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] action: Specifies the action to take when the source sends traffic to the destination service. The value is either allow or deny.
...
class ConfigEntryServiceIntentionsSourcePermissionHttpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path_exact: Specifies an exact path to match on the HTTP request path.
        :param pulumi.Input[_builtins.str] path_prefix: Specifies a path prefix to match on the HTTP request path.
        :param pulumi.Input[_builtins.str] path_regex: Defines a regular expression to match on the HTTP request path.
        """
...
class ConfigEntryServiceIntentionsSourcePermissionHttpHeaderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] invert: Inverts the matching logic configured in the Header.
        :param pulumi.Input[_builtins.str] prefix: Specifies a prefix value for the header key set in the Name field.
        :param pulumi.Input[_builtins.bool] present: Enables a match if the header configured in the Name field appears in the request. Consul matches on any value as long as the header key appears in the request.
        :param pulumi.Input[_builtins.str] regex: Specifies a regular expression pattern as the value for the header key set in the Name field.
        :param pulumi.Input[_builtins.str] suffix: Specifies a suffix value for the header key set in the Name field.
        """
        pulumi.set(__self__, "name", name)
...
class ConfigEntryServiceResolverFailoverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace at the failover location where the failover services are deployed.
        :param pulumi.Input[_builtins.str] sameness_group: Specifies the sameness group at the failover location where the failover services are deployed.
        :param pulumi.Input[_builtins.str] service: Specifies the name of the service to resolve at the failover location during a failover scenario.
        :param pulumi.Input[_builtins.str] service_subset: Specifies the name of a subset of service instances to resolve at the failover location during a failover scenario.
    ...
    def subset_name(self) -> pulumi.Input[_builtins.str]:
        """
        Name of subset.
        """
    ...
    @subset_name.setter
    def subset_name(self, value: pulumi.Input[_builtins.str]):
...
class ConfigEntryServiceResolverFailoverTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] partition: Specifies the admin partition within the same datacenter to use for the failover target. If empty, the default partition is used.
        :param pulumi.Input[_builtins.str] peer: Specifies the destination cluster peer to resolve the target service name from.
        :param pulumi.Input[_builtins.str] service: Specifies the service name to use for the failover target. If empty, the current service name is used.
        :param pulumi.Input[_builtins.str] service_subset: Specifies the named subset to use for the failover target. If empty, the default subset for the requested service name is used.
        """
...
class ConfigEntryServiceResolverLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy: Specifies the type of load balancing policy for selecting a host.
...
class ConfigEntryServiceResolverLoadBalancerHashPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] field_value: Specifies the value to hash, such as a header name, cookie name, or a URL query parameter name.
        :param pulumi.Input[_builtins.bool] source_ip: Determines if the hash type should be source IP address.
        :param pulumi.Input[_builtins.bool] terminal: Determines if Consul should stop computing the hash when multiple hash policies are present.
        """
...
class ConfigEntryServiceResolverLoadBalancerHashPolicyCookieConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ttl: Specifies the TTL for generated cookies. Cannot be specified for session cookies.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
...
class ConfigEntryServiceResolverRedirectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] partition: Specifies the admin partition at the redirect’s destination that resolves local upstream requests.
        :param pulumi.Input[_builtins.str] peer: Specifies the cluster with an active cluster peering connection at the redirect’s destination that resolves local upstream requests.
        :param pulumi.Input[_builtins.str] sameness_group: Specifies the sameness group at the redirect’s destination that resolves local upstream requests.
        :param pulumi.Input[_builtins.str] service: Specifies the name of a service at the redirect’s destination that resolves local upstream requests.
        :param pulumi.Input[_builtins.str] service_subset: Specifies the name of a subset of services at the redirect’s destination that resolves local upstream requests. If empty, the default subset is used. If specified, you must also specify at least one of the following in the same Redirect map: Service, Namespace, andDatacenter.
        """
        if datacenter is not None:
            pulumi.set(__self__, "datacenter", datacenter)
        if namespace is not None:
...
class ConfigEntryServiceResolverSubsetArgsDict(TypedDict):
    ...
    Name of subset.
    """
    only_passing: pulumi.Input[_builtins.bool]
    """
...
class ConfigEntryServiceResolverSubsetArgs:
    def __init__(__self__, *,
                 ...
                 only_passing: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.str] filter: Specifies an expression that filters the DNS elements of service instances that belong to the subset. If empty, all healthy instances of a service are returned.
        :param pulumi.Input[_builtins.str] name: Name of subset.
        :param pulumi.Input[_builtins.bool] only_passing: Determines if instances that return a warning from a health check are allowed to resolve a request. When set to false, instances with passing and warning states are considered healthy. When set to true, only instances with a passing health check state are considered healthy.
        """
    ...
    def only_passing(self) -> pulumi.Input[_builtins.bool]:
        """
        Determines if instances that return a warning from a health check are allowed to resolve a request. When set to false, instances with passing and warning states are considered healthy. When set to true, only instances with a passing health check state are considered healthy.
        """
    ...
    @only_passing.setter
    def only_passing(self, value: pulumi.Input[_builtins.bool]):
...
class ConfigEntryServiceRouterRouteDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] num_retries: Specifies the number of times to retry the request when a retry condition occurs.
        :param pulumi.Input[_builtins.str] partition: Specifies the Consul admin partition to resolve the service from instead of the current partition.
        :param pulumi.Input[_builtins.str] prefix_rewrite: Specifies rewrites to the HTTP request path before proxying it to its final destination.
        ...
        :param pulumi.Input[_builtins.str] request_timeout: Specifies the total amount of time permitted for the entire downstream request to be processed, including retry attempts.
        ...
        :param pulumi.Input[_builtins.bool] retry_on_connect_failure: Specifies that connection failure errors that trigger a retry request.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] retry_on_status_codes: Specifies a list of integers for HTTP response status codes that trigger a retry request.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] retry_ons: Specifies a list of conditions for Consul to retry requests based on the response from an upstream service.
        :param pulumi.Input[_builtins.str] service: Specifies the name of the service to resolve.
        :param pulumi.Input[_builtins.str] service_subset: Specifies a named subset of the given service to resolve instead of the one defined as that service's `default_subset` in the service resolver configuration entry.
        """
...
class ConfigEntryServiceRouterRouteDestinationRequestHeadersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] set: Defines a set of key-value pairs to add to the request header or to replace existing header values with.
        """
        if add is not None:
...
class ConfigEntryServiceRouterRouteDestinationResponseHeadersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] add: Defines a set of key-value pairs to add to the header. Use header names as the keys
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] removes: Defines a list of headers to remove.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] set: Defines a set of key-value pairs to add to the response header or to replace existing header values with
        """
        if add is not None:
            pulumi.set(__self__, "add", add)
        if removes is not None:
...
class ConfigEntryServiceRouterRouteMatchHttpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path_exact: Specifies the exact path to match on the HTTP request path.
        :param pulumi.Input[_builtins.str] path_prefix: Specifies the path prefix to match on the HTTP request path.
        :param pulumi.Input[_builtins.str] path_regex: Specifies a regular expression to match on the HTTP request path.
...
class ConfigEntryServiceRouterRouteMatchHttpHeaderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the HTTP header to match.
        :param pulumi.Input[_builtins.str] prefix: Specifies that a request matches when the header with the given name has this prefix.
        :param pulumi.Input[_builtins.bool] present: Specifies that a request matches when the value in the `name` argument is present anywhere in the HTTP header.
        :param pulumi.Input[_builtins.str] regex: Specifies that a request matches when the header with the given name matches this regular expression.
        :param pulumi.Input[_builtins.str] suffix: Specifies that a request matches when the header with the given name has this suffix.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if invert is not None:
...
class ConfigEntryServiceRouterRouteMatchHttpQueryParamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] present: Specifies that a request matches when the value in the `name` argument is present anywhere in the HTTP query parameter.
        :param pulumi.Input[_builtins.str] regex: Specifies that a request matches when the query parameter with the given name matches this regular expression.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if name is not None:
...
class ConfigEntryServiceSplitterSplitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace: Specifies the namespace to use in the FQDN when resolving the service.
        :param pulumi.Input[_builtins.str] partition: Specifies the admin partition to use in the FQDN when resolving the service.
        ...
        :param pulumi.Input[_builtins.str] service_subset: Specifies a subset of the service to resolve. A service subset assigns a name to a specific subset of discoverable service instances within a datacenter, such as `version2` or `canary`. All services have an unnamed default subset that returns all healthy instances.
        """
        pulumi.set(__self__, "service", service)
...
class KeyPrefixSubkeyCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path: This is the path (which will be appended to the given
               `path_prefix`) in Consul that should be written to.
        :param pulumi.Input[_builtins.str] value: The value to write to the given path.
        :param pulumi.Input[_builtins.int] flags: An [unsigned integer value](https://www.consul.io/api/kv.html#flags-1)
               to attach to the key (defaults to 0).
        """
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "value", value)
...
class PreparedQueryTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] remove_empty_tags: If set to true, will cause the tags list inside the service structure to be stripped of any empty strings.
        """
...
class ProviderAuthLoginAwsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] meta: Specifies arbitrary KV metadata linked to the token. Can be useful to track origins.
        :param pulumi.Input[_builtins.str] namespace: The Consul namespace to authenticate to.
        :param pulumi.Input[_builtins.str] partition: The Consul admin partition to authenticate to.
        :param pulumi.Input[_builtins.str] server_id_header_value: The Consul Server ID header value to include in the STS signing request. This must match the ServerIDHeaderValue configured in the Consul auth method.
        """
        pulumi.set(__self__, "auth_method", auth_method)
...
class ServiceCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] timeout: Specifies a timeout for outgoing connections in the case of a HTTP or TCP check.
        :param pulumi.Input[_builtins.str] deregister_critical_service_after: The time after which the service is automatically deregistered when in the `critical` state. Defaults to `30s`. Setting to `0` will disable.
        ...
        :param pulumi.Input[_builtins.str] http: The HTTP endpoint to call for an HTTP check.
        :param pulumi.Input[_builtins.str] method: The method to use for HTTP health-checks. Defaults to `GET`.
        :param pulumi.Input[_builtins.str] notes: An opaque field meant to hold human readable text.
        :param pulumi.Input[_builtins.str] status: The initial health-check status.
        :param pulumi.Input[_builtins.str] tcp: The TCP address and port to connect to for a TCP check.
        :param pulumi.Input[_builtins.bool] tls_skip_verify: Whether to deactivate certificate verification for HTTP health-checks. Defaults to `false`.
        """
...
class ServiceCheckHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of the header.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: The header's list of values.
        """
        pulumi.set(__self__, "name", name)
...
class GetCatalogNodesQueryOptionArgsDict(TypedDict):
    allow_stale: NotRequired[_builtins.bool]
    """
    When `true`, the default, allow responses from
    Consul servers that are followers.
    """
    datacenter: NotRequired[_builtins.str]
    """
    ...
    """
    near: NotRequired[_builtins.str]
    node_meta: NotRequired[Mapping[str, _builtins.str]]
    partition: NotRequired[_builtins.str]
    require_consistent: NotRequired[_builtins.bool]
    """
    ...
    """
    wait_index: NotRequired[_builtins.int]
    """
    Index number used to enable blocking queries.
    """
    wait_time: NotRequired[_builtins.str]
    """
...
class GetCatalogNodesQueryOptionArgs:
    ...
    @allow_stale.setter
    def allow_stale(self, value: Optional[_builtins.bool]):
    ...
    @near.setter
    def near(self, value: Optional[_builtins.str]):
    ...
    @node_meta.setter
    def node_meta(self, value: Optional[Mapping[str, _builtins.str]]):
    ...
    @partition.setter
    def partition(self, value: Optional[_builtins.str]):
        pulumi.set(self, "partition", value)
    ...
    def require_consistent(self, value: Optional[_builtins.bool]):
    ...
    @wait_index.setter
    def wait_index(self, value: Optional[_builtins.int]):
    ...
    @wait_time.setter
    def wait_time(self, value: Optional[_builtins.str]):
...
class GetKeyPrefixSubkeyCollectionArgsDict(TypedDict):
    ...
    to read the value.
    """
    default: NotRequired[_builtins.str]
    """
...
class GetKeyPrefixSubkeyCollectionArgs:
    ...
    @default.setter
    def default(self, value: Optional[_builtins.str]):
        pulumi.set(self, "default", value)
