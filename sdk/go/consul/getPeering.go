...
//			_, err := consul.GetPeering(ctx, &consul.LookupPeeringArgs{
...
func LookupPeeringOutput(ctx *pulumi.Context, args LookupPeeringOutputArgs, opts ...pulumi.InvokeOption) LookupPeeringResultOutput {
	...
	return ctx.InvokeOutput("consul:index/getPeering:getPeering", args, LookupPeeringResultOutput{}, options).(LookupPeeringResultOutput)
}
