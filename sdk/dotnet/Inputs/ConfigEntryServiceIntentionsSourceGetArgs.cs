...
namespace Pulumi.Consul.Inputs
{
    ...
    public sealed class ConfigEntryServiceIntentionsSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("permissions")]
        private InputList<Inputs.ConfigEntryServiceIntentionsSourcePermissionGetArgs>? _permissions;
        ...
        /// </summary>
        public InputList<Inputs.ConfigEntryServiceIntentionsSourcePermissionGetArgs> Permissions
        {
            get => _permissions ?? (_permissions = new InputList<Inputs.ConfigEntryServiceIntentionsSourcePermissionGetArgs>());
        ...
        public ConfigEntryServiceIntentionsSourceGetArgs()
        {
        }
        public static new ConfigEntryServiceIntentionsSourceGetArgs Empty => new ConfigEntryServiceIntentionsSourceGetArgs();
    }
}
