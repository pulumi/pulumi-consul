...
namespace Pulumi.Consul.Inputs
{
    ...
    public sealed class ConfigEntryServiceResolverFailoverGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("datacenters")]
        ...
        [Input("targets")]
        private InputList<Inputs.ConfigEntryServiceResolverFailoverTargetGetArgs>? _targets;

        /// <summary>
        /// Specifies a fixed list of failover targets to try during failover. This list can express complicated failover scenarios.
        /// </summary>
        public InputList<Inputs.ConfigEntryServiceResolverFailoverTargetGetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.ConfigEntryServiceResolverFailoverTargetGetArgs>());
            set => _targets = value;
        }

        public ConfigEntryServiceResolverFailoverGetArgs()
        {
        }
        public static new ConfigEntryServiceResolverFailoverGetArgs Empty => new ConfigEntryServiceResolverFailoverGetArgs();
    }
}
