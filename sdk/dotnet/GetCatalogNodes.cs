...
namespace Pulumi.Consul
{
    public static partial class Invokes
    {
        public static Task<GetCatalogNodesResult> GetCatalogNodes(GetCatalogNodesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCatalogNodesResult>("consul:index/getCatalogNodes:getCatalogNodes", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetCatalogNodesArgs : Pulumi.ResourceArgs
    {
        [Input("queryOptions")]
        private InputList<Inputs.GetCatalogNodesQueryOptionsArgs>? _queryOptions;
        public InputList<Inputs.GetCatalogNodesQueryOptionsArgs> QueryOptions
        {
            get => _queryOptions ?? (_queryOptions = new InputList<Inputs.GetCatalogNodesQueryOptionsArgs>());
    ...
    public sealed class GetCatalogNodesQueryOptionsArgs : Pulumi.ResourceArgs
    {
        [Input("allowStale")]
