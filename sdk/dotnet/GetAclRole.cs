...
namespace Pulumi.Consul
{
    ...
    public sealed class GetAclRoleArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("policies")]
        private InputList<Inputs.GetAclRolePoliciesArgs>? _policies;
        public InputList<Inputs.GetAclRolePoliciesArgs> Policies
        {
            get => _policies ?? (_policies = new InputList<Inputs.GetAclRolePoliciesArgs>());
            set => _policies = value;
        }

        [Input("serviceIdentities")]
        private InputList<Inputs.GetAclRoleServiceIdentitiesArgs>? _serviceIdentities;
        public InputList<Inputs.GetAclRoleServiceIdentitiesArgs> ServiceIdentities
        {
            get => _serviceIdentities ?? (_serviceIdentities = new InputList<Inputs.GetAclRoleServiceIdentitiesArgs>());
    ...
    public sealed class GetAclRolePoliciesArgs : Pulumi.ResourceArgs
    {
        [Input("id")]
    ...
    public sealed class GetAclRoleServiceIdentitiesArgs : Pulumi.ResourceArgs
    {
        [Input("datacenters")]
