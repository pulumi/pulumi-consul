...
namespace Pulumi.Consul
{
    public static partial class Invokes
    {
        public static Task<GetCatalogServiceResult> GetCatalogService(GetCatalogServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCatalogServiceResult>("consul:index/getCatalogService:getCatalogService", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetCatalogServiceArgs : Pulumi.ResourceArgs
    {
        [Input("datacenter")]
        ...
        [Input("queryOptions")]
        private InputList<Inputs.GetCatalogServiceQueryOptionsArgs>? _queryOptions;
        public InputList<Inputs.GetCatalogServiceQueryOptionsArgs> QueryOptions
        {
            get => _queryOptions ?? (_queryOptions = new InputList<Inputs.GetCatalogServiceQueryOptionsArgs>());
    ...
    public sealed class GetCatalogServiceQueryOptionsArgs : Pulumi.ResourceArgs
    {
        [Input("allowStale")]
