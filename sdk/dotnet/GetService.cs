...
namespace Pulumi.Consul
{
    ...
    public sealed class GetServiceArgs : Pulumi.InvokeArgs
    {
        ...
        [Input("queryOptions")]
        private List<Inputs.GetServiceQueryOptionsArgs>? _queryOptions;

        /// <summary>
        /// See below.
        /// </summary>
        public List<Inputs.GetServiceQueryOptionsArgs> QueryOptions
        {
            get => _queryOptions ?? (_queryOptions = new List<Inputs.GetServiceQueryOptionsArgs>());
